/**
 * =============================================================================
 * THIAGUINHO CORE v9.0 (SAFE BOOT & HIGH DPI)
 * =============================================================================
 * Correções: 
 * 1. Boot seguro com timeout para evitar travamento em 'onloadedmetadata'.
 * 2. Suporte a Retina/High DPI para nitidez máxima.
 * 3. Gerenciamento de erro de permissão de câmera.
 * =============================================================================
 */
...
window.System = {
    ...
    boot: async function() {
        ...
        try {
            // 1. Tentar obter câmera
            log.innerText = "SOLICITANDO CÂMERA...";
            ...
            // 2. Play Seguro com Timeout (O PULO DO GATO)
            log.innerText = "SINCRONIZANDO VÍDEO...";
            ...
            console.error(e);
            alert("ERRO DE INICIALIZAÇÃO:\n" + e.message + "\n\nVerifique se deu permissão à câmera.");
            // Tenta ir para o menu mesmo sem câmera para não travar totalmente
            safetyScreen.classList.add('hidden');
            loadScreen.classList.add('hidden');
            this.menu(); 
        }
    ...
    msg: function(t) {
        ...
        if(el) {
            ...
            el.classList.add('pop'); // Garante animação
            setTimeout(() => {
